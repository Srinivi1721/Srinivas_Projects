...
<!--content-->
	...
	<div class="contact-top">
				...
				<form name="form1" method="post" action="">
                  <table width="427" height="134" border="0" align="center">
                    <tr>
                      <td width="225"><div align="center" class="style1">Date</div></td>
                      <td width="192"><div align="center" class="style1">Vaccine Name </div></td>
                    </tr>
                    <?php
$qq="Select * from  baby_details where username='$username'";
     ...
     <tr>
       ...
       <td><div align="center"><?php echo $row['vaccine_name'];?></div></td>
       </tr>
	 <?php
	 }
	 ?>
